  ...
  <div>
    ...
    <section style="padding:80px 40px;max-width:1200px;margin:0 auto;">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:24px;">
        ${gameCard('Roulette Américaine', 'Misez sur les couleurs, les numéros ou les douzaines', 'https://images.unsplash.com/photo-1606166325683-e6deb697d301?w=800&q=80', '#/games/roulette')}
        ${gameCard('Machine à Sous', 'Alignez les symboles pour décrocher le jackpot', 'https://images.unsplash.com/photo-1534126511673-b6899657816a?w=800&q=80', '#/games/slots')}
        ${crashCard()}
      </div>
    </section>
...
function crashCard() {
  return `
  <div onclick="navigatePage('#/games/crash')" class="card" style="cursor:pointer;overflow:hidden;padding:0;position:relative;height:320px;
    background:linear-gradient(135deg,#0a1a0a,#080808);border:1px solid rgba(201,168,76,0.2);">
    <!-- Graphique décoratif SVG -->
    <svg style="position:absolute;inset:0;width:100%;height:100%;opacity:0.3;" viewBox="0 0 400 300">
      <polyline points="0,280 80,240 160,180 220,120 280,80 320,60 380,20" fill="none" stroke="#C9A84C" stroke-width="2"/>
    </svg>
    <div style="position:absolute;bottom:0;left:0;right:0;padding:24px;">
      <h3 style="font-family:'Cinzel';color:#fff;font-size:20px;margin-bottom:8px;">Crash</h3>
      <p style="font-family:'Jost';color:var(--text-secondary);font-size:14px;margin-bottom:16px;">Cash out avant le crash ou perdez tout</p>
      <button class="btn-outline-gold" style="font-size:13px;padding:8px 20px;">Découvrir →</button>
    </div>
  </div>`;
}
